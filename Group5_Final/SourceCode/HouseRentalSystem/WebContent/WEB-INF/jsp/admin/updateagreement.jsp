        ...
        $().ready(function() {
            ...
            $("#myform").validate({
                ...
                messages : {
                    ...
                    lease_idcard: {
                        required : "Lessor ID number cannot be empty",
                    ...
                    tenant_idcard: {
                        required : "Lessee ID number cannot be empty",
                    ...
                    payday: {
                        required : "Monthly rent payment day cannot be empty",
                        min:"Monthly rent payment day must be greater than 0",
                        max:"Monthly rent payment day must be less than 31",
                    }
...
<div class="result-title">
    <h1>Modify contract information, please make sure the contract information is correct before submitting!</h1>
</div>
<div class="result-content">
    <div class="sidebar-title">
        <form action="/HouseRentalSystem/agreement/changeagreement.action" method="post" id="myform" name="myform" enctype="multipart/form-data" >
            <table class="insert-tab" width="100%">
                ...
                <tr>
                    <th><i class="require-red">*</i>Lessor (Party A) ID number:</th>
                ...
                <tr>
                    <th><i class="require-red">*</i>Lessee (Party B) ID number:</th>
                ...
                <tr>
                    <th><i class="require-red">*</i>Monthly rent payment day (number):</th>
