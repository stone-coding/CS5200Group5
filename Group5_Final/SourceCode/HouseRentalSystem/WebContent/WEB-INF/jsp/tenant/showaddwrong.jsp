...
<head>
	...
	<script type="text/javascript">
		...
		if(error=="insertwrong"){
			...
			alert("Fault information has been added, the administrator will receive your request.");
		}
...
<div>
	...
	<form id="houseForm" name="houseForm"
		  action="/HouseRentalSystem/wrong/showaddwrong.action"
		  method=post >
		<div class="result-title">
				...
				<c:forEach items="${rentlist}" var="rentlist">
					...
					<tr
						...
						<td><a class="link-update"
							   href="/HouseRentalSystem/wrong/addwrong.action?id=${rentlist.rentid }">Report Fault</a>
							&nbsp;&nbsp;
