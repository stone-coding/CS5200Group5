...
<div><br />
	<form name="agreement" action="/HouseRentalSystem/agreement/updateagreement.action">
		...
		<p>According to the relevant provisions of the "House Contract Law", Party A and Party B have reached the following agreement after full consultation on the lease of Party A's house by Party B:</p>
		...
		<p>2. Lease start date: <span name="fromdate">${agreement.fromdate}</span>, lease end date: <span name="todate">${agreement.todate}</span>.
			On the date of signing the contract, Party B shall pay Party A a house rent of ￥<span name="price">${agreement.price}</span>. If renewing the lease, please notify Party A 3 days in advance and re-handle the lease procedures.<br /></p>
		...
		<p>2. If the maintenance services provided by Party A do not match the agreement, Party B has the right to terminate the lease early, and Party A shall refund the remaining rent in full.</p>
		<p>Party B's breach of contract:</p>
		<p>1. If Party B fails to pay the rent on time, Party A has the right to deduct it from the deposit and reclaim the house, and all losses shall be borne by Party B;</p>
		<p>2. If Party B terminates the lease before the lease term expires, Party A will only refund 40% of the remaining rent (this does not apply to lease terms of less than one month);</p>
		...
		<div class="button">
			<input class="btn btn-primary btn6 mr10" value="Modify Agreement" type="submit">
