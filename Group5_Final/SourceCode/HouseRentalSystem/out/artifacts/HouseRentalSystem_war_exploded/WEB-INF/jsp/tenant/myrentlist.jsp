...
<div>
	...
	<form id="houseForm" name="houseForm"
		  action="/HouseRentalSystem/rentlist/myrentlist.action" method=post>
		<div class="result-title">
		...
		<div class="result-content">
			<table id=grid class="result-tab" width="100%">
				...
				<c:forEach items="${userlistrent}" varStatus="i" var="userlist">

					<tr
					style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
					<c:forEach items="${userlist.rentlist}" var="rentlist">
						<td>${userlist.name }</td>
						...
						<td><a class="link-update"
							   href="/HouseRentalSystem/agreement/tenantseeagreement.action?house_id=${rentlist.house_id }">View Agreement</a>
							&nbsp;&nbsp; <a class="link-del"
											href="/HouseRentalSystem/applyout/insertapplyout.action?house_id=${rentlist.house_id }"
											onclick="return window.confirm('Are you sure you want to apply for a return rental?')">Apply for Terminate Rental</a></td>
